  ...
  return (
    <div className="relative min-h-dvh w-full">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(10,28,46,0.28), rgba(8,22,36,0.72)), url(${SHELL.bgTitleHero})`,
        }}
        aria-hidden
      />
      <Screen className="relative z-10 items-center justify-center gap-8 text-center">
        <motion.div
        ...
        >
          <motion.img
            src={SHELL.mark}
            alt=""
            className="h-28 w-28 drop-shadow-[0_10px_22px_rgba(0,0,0,0.45)]"
            animate={{ y: [0, -10, 0], rotate: [0, -3, 3, 0] }}
            transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
            aria-hidden
          />
          <h1
            className="font-display text-6xl leading-none text-[#ffe7a0] title-glow"
          ...
          <p className="max-w-xs text-sm text-[#e4f3fa]">
            Answer trivia. Betray your friends. Get{" "}
            <span className="font-black text-[#ffe18a]">rich</span>.
          </p>
          <div className="flex gap-1.5 text-xs text-[#c5dce9]">
        ...
        {effectiveMode === "landing" ? (
          ...
          >
            ...
            {!connected && <p className="text-xs text-slate-300">Connecting...</p>}
          </motion.form>
        )}
      </Screen>
    </div>
