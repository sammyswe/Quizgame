...
export function Hud() {
  ...
  return (
    <div className="sticky top-0 z-30 -mx-4 mb-3 border-b border-white/10 bg-abyss/90 px-4 pb-2 pt-3 backdrop-blur">
        ...
        <div className="flex items-center gap-3">
          {me.roundLoot !== 0 && (
            <div className="text-right">
              ...
              <div className="text-[10px] uppercase tracking-wide text-slate-500">unbanked</div>
            </div>
          )}
          <div className="text-right">
            ...
            <div className="text-[10px] uppercase tracking-wide text-slate-500">banked gold</div>
          </div>
        </div>
      </div>
