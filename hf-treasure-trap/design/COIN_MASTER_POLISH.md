# Coin Master → Treasure Trap polish translation

Owner rank #1 reference for feel (still Brawl Stars / Clash Royale for silhouettes & movement).

| Coin Master pattern | Voyage application |
| --- | --- |
...
Smoothness checklist every playtest:

1. Ships never cross baked land  
2. Facing updates every few degrees (16 dirs) without popping  
3. Idle flap loops while waiting  
4. Travel eases in/out (~1.1s)  
5. Exit shrinks toward horizon top  
