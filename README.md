...
> **Also on this repo:** greenfield design bank — start at [`RESTART.md`](RESTART.md) and [`AGENT_LOOP_ROADMAP.md`](AGENT_LOOP_ROADMAP.md). Voyage LOCKED decisions live in `docs/decisions/voyage/`.
