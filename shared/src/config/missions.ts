...
export const MISSIONS: Record<MissionId, MissionDef> = {
  falseFriend: {
    ...
    name: "False Friend",
    icon: "🎣",
    description: "Trick your target into picking your trap answer.",
    deceptive: true,
    implemented: true,
    needsTarget: true,
    needsOption: true,
  ...
  piedPiper: {
    ...
    name: "Pied Piper",
    icon: "🪈",
    description: "Get 2+ pirates to copy your answer.",
    deceptive: true,
    implemented: true,
  },
  honestCaptain: {
    ...
    name: "Honest Captain",
    icon: "😇",
    description: "Answer right AND get someone to follow you.",
    deceptive: false,
    implemented: true,
  },
  snakeOil: {
    ...
    name: "Snake Oil",
    icon: "🐍",
    description: "Make the leader answer wrong.",
    deceptive: true,
    implemented: true,
  },
  loudLiar: {
  ...
  pirateProphet: {
    ...
    name: "Pirate Prophet",
    icon: "🔮",
    description: "Predict who answers wrong. Right guess pays.",
    deceptive: false,
    implemented: true,
    needsTarget: true,
  },
  mutinyBait: {
    ...
    name: "Mutiny Bait",
    icon: "🪤",
    description: "Bait someone into falsely accusing you.",
    deceptive: false,
    implemented: true,
  },
  loneTreasure: {
    ...
    name: "Lone Treasure",
    icon: "💎",
    description: "Be the ONLY one to answer right.",
    deceptive: false,
    implemented: true,
  },
  herdTrap: {
